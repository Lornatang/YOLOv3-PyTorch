...
def strip_optimizer(f='weights/last.pth'):  # from utils.utils import *; strip_optimizer()
...
def create_backbone(f='weights/last.pth'):  # from utils.utils import *; create_backbone()
    ...
    for p in x['model'].values():
        try:
            ...
            pass
    torch.save(x, 'weights/backbone.pth')
